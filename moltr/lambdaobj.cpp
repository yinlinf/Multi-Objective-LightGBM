...
#define __PYX_HAVE__lambdaobj
#define __PYX_HAVE_API__lambdaobj
/* Early includes */
#include <omp.h>
#include <math.h>
#include <string.h>
...
/* Module declarations from 'argsort' */

/* Module declarations from 'lambdaobj' */
...
static double __pyx_f_9lambdaobj_get_sigmoid(double, double *, int, double, double, double); /*proto*/
static void __pyx_f_9lambdaobj_get_gradients_for_one_query(double *, double *, long, long, double *, double *, double *, double, double *, long, double, double, double); /*proto*/
static void __pyx_f_9lambdaobj__get_gradients(double *, double *, long, long *, long *, long, double *, double *, double *, long, double, double, double, double *, double *); /*proto*/
...
#define __Pyx_MODULE_NAME "lambdaobj"
extern int __pyx_module_is_main_lambdaobj;
int __pyx_module_is_main_lambdaobj = 0;

/* Implementation of 'lambdaobj' */
...
static const char __pyx_k_discounts[] = "discounts";
static const char __pyx_k_enumerate[] = "enumerate";
static const char __pyx_k_lambdaobj[] = "lambdaobj";
...
static const char __pyx_k_sigmoid_table[] = "sigmoid_table";
static const char __pyx_k_n_sigmoid_bins[] = "n_sigmoid_bins";
static const char __pyx_k_View_MemoryView[] = "View.MemoryView";
static const char __pyx_k_allocate_buffer[] = "allocate_buffer";
static const char __pyx_k_dtype_is_object[] = "dtype_is_object";
static const char __pyx_k_max_sigmoid_arg[] = "max_sigmoid_arg";
static const char __pyx_k_min_sigmoid_arg[] = "min_sigmoid_arg";
static const char __pyx_k_pyx_PickleError[] = "__pyx_PickleError";
static const char __pyx_k_setstate_cython[] = "__setstate_cython__";
static const char __pyx_k_inverse_max_dcgs[] = "inverse_max_dcgs";
static const char __pyx_k_query_boundaries[] = "query_boundaries";
static const char __pyx_k_pyx_unpickle_Enum[] = "__pyx_unpickle_Enum";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_sigmoid_idx_factor[] = "sigmoid_idx_factor";
static const char __pyx_k_strided_and_direct[] = "<strided and direct>";
static const char __pyx_k_moltr_lambdaobj_pyx[] = "moltr/lambdaobj.pyx";
...
static PyObject *__pyx_n_s_inverse_max_dcgs;
static PyObject *__pyx_n_s_itemsize;
static PyObject *__pyx_kp_s_itemsize_0_for_cython_array;
static PyObject *__pyx_n_s_lambdaobj;
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_max_sigmoid_arg;
static PyObject *__pyx_n_s_memview;
static PyObject *__pyx_n_s_min_sigmoid_arg;
static PyObject *__pyx_n_s_mode;
static PyObject *__pyx_kp_s_moltr_lambdaobj_pyx;
static PyObject *__pyx_n_s_n_preds;
static PyObject *__pyx_n_s_n_queries;
static PyObject *__pyx_n_s_n_sigmoid_bins;
...
static PyObject *__pyx_n_s_query_boundaries;
...
static PyObject *__pyx_n_s_sigmoid_idx_factor;
static PyObject *__pyx_n_s_sigmoid_table;
...
static PyObject *__pyx_pf_9lambdaobj_get_gradients(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_gains, __Pyx_memviewslice __pyx_v_preds, long __pyx_v_n_preds, __Pyx_memviewslice __pyx_v_groups, __Pyx_memviewslice __pyx_v_query_boundaries, long __pyx_v_n_queries, __Pyx_memviewslice __pyx_v_discounts, __Pyx_memviewslice __pyx_v_inverse_max_dcgs, __Pyx_memviewslice __pyx_v_sigmoid_table, long __pyx_v_n_sigmoid_bins, double __pyx_v_min_sigmoid_arg, double __pyx_v_max_sigmoid_arg, double __pyx_v_sigmoid_idx_factor, __Pyx_memviewslice __pyx_v_grad, __Pyx_memviewslice __pyx_v_hess); /* proto */
...
static double __pyx_f_9lambdaobj_get_sigmoid(double __pyx_v_score, double *__pyx_v_sigmoid_table, int __pyx_v_n_sigmoid_bins, double __pyx_v_min_sigmoid_arg, double __pyx_v_max_sigmoid_arg, double __pyx_v_sigmoid_idx_factor) {
  double __pyx_r;
  int __pyx_t_1;
 ...
 */
  __pyx_t_1 = ((__pyx_v_score <= __pyx_v_min_sigmoid_arg) != 0);
  if (__pyx_t_1) {
 ...
 */
    __pyx_r = (__pyx_v_sigmoid_table[0]);
    goto __pyx_L0;
 ...
 *     else:
 */
  __pyx_t_1 = ((__pyx_v_score >= __pyx_v_max_sigmoid_arg) != 0);
  if (__pyx_t_1) {
 ...
 */
    __pyx_r = (__pyx_v_sigmoid_table[(__pyx_v_n_sigmoid_bins - 1)]);
    goto __pyx_L0;
 ...
 */
  /*else*/ {
    __pyx_r = (__pyx_v_sigmoid_table[((int)((__pyx_v_score - __pyx_v_min_sigmoid_arg) * __pyx_v_sigmoid_idx_factor))]);
    goto __pyx_L0;
  }
...
static void __pyx_f_9lambdaobj_get_gradients_for_one_query(double *__pyx_v_gains, double *__pyx_v_preds, long __pyx_v_start, long __pyx_v_end, double *__pyx_v_grad, double *__pyx_v_hess, double *__pyx_v_discounts, double __pyx_v_inverse_max_dcg, double *__pyx_v_sigmoid_table, long __pyx_v_n_sigmoid_bins, double __pyx_v_min_sigmoid_arg, double __pyx_v_max_sigmoid_arg, double __pyx_v_sigmoid_idx_factor) {
  int __pyx_v_cnt;
  int *__pyx_v_sorted_idx;
  double __pyx_v_best_score;
  double __pyx_v_worst_score;
  int __pyx_v_should_adjust;
  double __pyx_v_p_hess;
  double __pyx_v_gain_high;
  double __pyx_v_gain_low;
  double __pyx_v_score_high;
  double __pyx_v_score_low;
  double __pyx_v_delta_score;
  double __pyx_v_abs_delta_ndcg;
  double __pyx_v_paired_discount;
  double __pyx_v_gain_diff;
  int __pyx_v_high;
  int __pyx_v_low;
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 * 
 */
  __pyx_v_cnt = ((int)(__pyx_v_end - __pyx_v_start));
 ...
 */
  __pyx_v_sorted_idx = ((int *)malloc((__pyx_v_cnt * (sizeof(int)))));
 ...
 */
  argsort(((&(__pyx_v_preds[0])) + __pyx_v_start), __pyx_v_sorted_idx, __pyx_v_cnt);
 ...
 */
  __pyx_v_best_score = (__pyx_v_preds[(__pyx_v_start + (__pyx_v_sorted_idx[0]))]);
 ...
 */
  __pyx_v_worst_score = (__pyx_v_preds[(__pyx_v_start + (__pyx_v_sorted_idx[(__pyx_v_cnt - 1)]))]);
 ...
 *     else:
 */
  __pyx_t_1 = ((__pyx_v_best_score != __pyx_v_worst_score) != 0);
  if (__pyx_t_1) {
 ...
 */
    __pyx_v_high = (__pyx_v_sorted_idx[__pyx_v_i]);
 ...
 *         for j in range(cnt):
 */
    __pyx_v_gain_high = (__pyx_v_gains[(__pyx_v_start + __pyx_v_high)]);
 ...
 *             low = sorted_idx[j]
 */
    __pyx_v_score_high = (__pyx_v_preds[(__pyx_v_start + __pyx_v_high)]);
 ...
 */
      __pyx_v_low = (__pyx_v_sorted_idx[__pyx_v_j]);
 ...
 */
      __pyx_v_gain_low = (__pyx_v_gains[(__pyx_v_start + __pyx_v_low)]);
 ...
 */
      __pyx_v_score_low = (__pyx_v_preds[(__pyx_v_start + __pyx_v_low)]);
 ...
 */
      __pyx_t_1 = ((__pyx_v_gain_high > __pyx_v_gain_low) != 0);
      if (__pyx_t_1) {
 ...
 *                                        sigmoid_table,
 */
        __pyx_v_delta_score = (__pyx_v_score_high - __pyx_v_score_low);
 ...
 *                                        n_sigmoid_bins,
 */
        __pyx_v_p_lambda = __pyx_f_9lambdaobj_get_sigmoid(__pyx_v_delta_score, __pyx_v_sigmoid_table, __pyx_v_n_sigmoid_bins, __pyx_v_min_sigmoid_arg, __pyx_v_max_sigmoid_arg, __pyx_v_sigmoid_idx_factor);
 ...
 */
        __pyx_v_p_hess = (__pyx_v_p_lambda * (2.0 - __pyx_v_p_lambda));
 ...
 */
        __pyx_v_gain_diff = (__pyx_v_gain_high - __pyx_v_gain_low);
 ...
 *                 if should_adjust == 1:
 */
        __pyx_v_paired_discount = fabs(((__pyx_v_discounts[(1 + __pyx_v_j)]) - (__pyx_v_discounts[(1 + __pyx_v_i)])));
 ...
 */
        __pyx_v_abs_delta_ndcg = ((__pyx_v_gain_diff * __pyx_v_paired_discount) * __pyx_v_inverse_max_dcg);
 ...
 * 
 */
        __pyx_t_1 = ((__pyx_v_should_adjust == 1) != 0);
        if (__pyx_t_1) {
 ...
 */
          __pyx_t_8 = (0.01 + fabs(__pyx_v_delta_score));
          ...
          __pyx_v_abs_delta_ndcg = (__pyx_v_abs_delta_ndcg / __pyx_t_8);
 ...
 * 
 */
        __pyx_v_p_lambda = (__pyx_v_p_lambda * (-__pyx_v_abs_delta_ndcg));
 ...
 */
        __pyx_v_p_hess = (__pyx_v_p_hess * (2.0 * __pyx_v_abs_delta_ndcg));
 ...
 */
        __pyx_t_9 = (__pyx_v_start + __pyx_v_high);
        (__pyx_v_grad[__pyx_t_9]) = ((__pyx_v_grad[__pyx_t_9]) + __pyx_v_p_lambda);
 ...
 */
        __pyx_t_9 = (__pyx_v_start + __pyx_v_high);
        (__pyx_v_hess[__pyx_t_9]) = ((__pyx_v_hess[__pyx_t_9]) + __pyx_v_p_hess);
 ...
 *     free(sorted_idx)
 */
        __pyx_t_9 = (__pyx_v_start + __pyx_v_low);
        (__pyx_v_grad[__pyx_t_9]) = ((__pyx_v_grad[__pyx_t_9]) - __pyx_v_p_lambda);
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("lambdaobj.get_gradients_for_one_query", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}
...
static void __pyx_f_9lambdaobj__get_gradients(double *__pyx_v_gains, double *__pyx_v_preds, long __pyx_v_n_preds, CYTHON_UNUSED long *__pyx_v_groups, long *__pyx_v_query_boundaries, CYTHON_UNUSED long __pyx_v_n_queries, double *__pyx_v_discounts, double *__pyx_v_inverse_max_dcgs, double *__pyx_v_sigmoid_table, long __pyx_v_n_sigmoid_bins, double __pyx_v_min_sigmoid_arg, double __pyx_v_max_sigmoid_arg, double __pyx_v_sigmoid_idx_factor, double *__pyx_v_grad, double *__pyx_v_hess) {
  double __pyx_v_inverse_max_dcg;
  long __pyx_v_start;
  long __pyx_v_end;
  long __pyx_v_i;
  long __pyx_t_1;
 ...
 * 
 */
  (void)(memset(__pyx_v_grad, 0, (__pyx_v_n_preds * (sizeof(double)))));
 ...
 */
  (void)(memset(__pyx_v_hess, 0, (__pyx_v_n_preds * (sizeof(double)))));
      ...
      /*try:*/ {
        ...
        if ((1 == 0)) abort();
        {
            ...
            if (__pyx_t_3 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_end) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_inverse_max_dcg) lastprivate(__pyx_v_start)
                    #endif /* _OPENMP */
                    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                        {
                            __pyx_v_i = (long)(0 + 1 * __pyx_t_2);
                            /* Initialize private variables to invalid values */
                            __pyx_v_end = ((long)0xbad0bad0);
                            __pyx_v_inverse_max_dcg = ((double)__PYX_NAN());
 ...
 */
                            __pyx_v_start = (__pyx_v_query_boundaries[__pyx_v_i]);
 ...
 */
                            __pyx_v_end = (__pyx_v_query_boundaries[(__pyx_v_i + 1)]);
 ...
 *                                     preds,
 */
                            __pyx_v_inverse_max_dcg = (__pyx_v_inverse_max_dcgs[__pyx_v_i]);
 ...
 *                                     start,
 */
                            __pyx_f_9lambdaobj_get_gradients_for_one_query(__pyx_v_gains, __pyx_v_preds, __pyx_v_start, __pyx_v_end, __pyx_v_grad, __pyx_v_hess, __pyx_v_discounts, __pyx_v_inverse_max_dcg, __pyx_v_sigmoid_table, __pyx_v_n_sigmoid_bins, __pyx_v_min_sigmoid_arg, __pyx_v_max_sigmoid_arg, __pyx_v_sigmoid_idx_factor);
                        }
                    }
                }
            }
...
/* Python wrapper */
static PyObject *__pyx_pw_9lambdaobj_1get_gradients(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_9lambdaobj_1get_gradients = {"get_gradients", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9lambdaobj_1get_gradients, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9lambdaobj_1get_gradients(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_gains = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_preds = { 0, 0, { 0 }, { 0 }, { 0 } };
  long __pyx_v_n_preds;
  __Pyx_memviewslice __pyx_v_groups = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_query_boundaries = { 0, 0, { 0 }, { 0 }, { 0 } };
  long __pyx_v_n_queries;
  __Pyx_memviewslice __pyx_v_discounts = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_inverse_max_dcgs = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_sigmoid_table = { 0, 0, { 0 }, { 0 }, { 0 } };
  long __pyx_v_n_sigmoid_bins;
  double __pyx_v_min_sigmoid_arg;
  double __pyx_v_max_sigmoid_arg;
  double __pyx_v_sigmoid_idx_factor;
  __Pyx_memviewslice __pyx_v_grad = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_hess = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_gradients (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_gains,&__pyx_n_s_preds,&__pyx_n_s_n_preds,&__pyx_n_s_groups,&__pyx_n_s_query_boundaries,&__pyx_n_s_n_queries,&__pyx_n_s_discounts,&__pyx_n_s_inverse_max_dcgs,&__pyx_n_s_sigmoid_table,&__pyx_n_s_n_sigmoid_bins,&__pyx_n_s_min_sigmoid_arg,&__pyx_n_s_max_sigmoid_arg,&__pyx_n_s_sigmoid_idx_factor,&__pyx_n_s_grad,&__pyx_n_s_hess,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_gains)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_preds)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 1); __PYX_ERR(0, 142, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_preds)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 2); __PYX_ERR(0, 142, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_groups)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 3); __PYX_ERR(0, 142, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_query_boundaries)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 4); __PYX_ERR(0, 142, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_queries)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 5); __PYX_ERR(0, 142, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_discounts)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 6); __PYX_ERR(0, 142, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_inverse_max_dcgs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 7); __PYX_ERR(0, 142, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sigmoid_table)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 8); __PYX_ERR(0, 142, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_sigmoid_bins)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 9); __PYX_ERR(0, 142, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_min_sigmoid_arg)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 10); __PYX_ERR(0, 142, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_max_sigmoid_arg)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 11); __PYX_ERR(0, 142, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 12:
        if (likely((values[12] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sigmoid_idx_factor)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 12); __PYX_ERR(0, 142, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 13:
        if (likely((values[13] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_grad)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 13); __PYX_ERR(0, 142, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 14:
        if (likely((values[14] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_hess)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, 14); __PYX_ERR(0, 142, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_gradients") < 0)) __PYX_ERR(0, 142, __pyx_L3_error)
      }
    ...
    __pyx_v_gains = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_gains.memview)) __PYX_ERR(0, 142, __pyx_L3_error)
    __pyx_v_preds = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_preds.memview)) __PYX_ERR(0, 143, __pyx_L3_error)
    __pyx_v_n_preds = __Pyx_PyInt_As_long(values[2]); if (unlikely((__pyx_v_n_preds == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 144, __pyx_L3_error)
    __pyx_v_groups = __Pyx_PyObject_to_MemoryviewSlice_dc_long(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_groups.memview)) __PYX_ERR(0, 145, __pyx_L3_error)
    __pyx_v_query_boundaries = __Pyx_PyObject_to_MemoryviewSlice_dc_long(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_query_boundaries.memview)) __PYX_ERR(0, 146, __pyx_L3_error)
    __pyx_v_n_queries = __Pyx_PyInt_As_long(values[5]); if (unlikely((__pyx_v_n_queries == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 147, __pyx_L3_error)
    __pyx_v_discounts = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_discounts.memview)) __PYX_ERR(0, 148, __pyx_L3_error)
    __pyx_v_inverse_max_dcgs = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_inverse_max_dcgs.memview)) __PYX_ERR(0, 149, __pyx_L3_error)
    __pyx_v_sigmoid_table = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[8], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sigmoid_table.memview)) __PYX_ERR(0, 150, __pyx_L3_error)
    __pyx_v_n_sigmoid_bins = __Pyx_PyInt_As_long(values[9]); if (unlikely((__pyx_v_n_sigmoid_bins == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 151, __pyx_L3_error)
    __pyx_v_min_sigmoid_arg = __pyx_PyFloat_AsDouble(values[10]); if (unlikely((__pyx_v_min_sigmoid_arg == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 152, __pyx_L3_error)
    __pyx_v_max_sigmoid_arg = __pyx_PyFloat_AsDouble(values[11]); if (unlikely((__pyx_v_max_sigmoid_arg == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 153, __pyx_L3_error)
    __pyx_v_sigmoid_idx_factor = __pyx_PyFloat_AsDouble(values[12]); if (unlikely((__pyx_v_sigmoid_idx_factor == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 154, __pyx_L3_error)
    __pyx_v_grad = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[13], PyBUF_WRITABLE); if (unlikely(!__pyx_v_grad.memview)) __PYX_ERR(0, 155, __pyx_L3_error)
    __pyx_v_hess = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[14], PyBUF_WRITABLE); if (unlikely(!__pyx_v_hess.memview)) __PYX_ERR(0, 156, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_gradients", 1, 15, 15, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 142, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("lambdaobj.get_gradients", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9lambdaobj_get_gradients(__pyx_self, __pyx_v_gains, __pyx_v_preds, __pyx_v_n_preds, __pyx_v_groups, __pyx_v_query_boundaries, __pyx_v_n_queries, __pyx_v_discounts, __pyx_v_inverse_max_dcgs, __pyx_v_sigmoid_table, __pyx_v_n_sigmoid_bins, __pyx_v_min_sigmoid_arg, __pyx_v_max_sigmoid_arg, __pyx_v_sigmoid_idx_factor, __pyx_v_grad, __pyx_v_hess);
...
static PyObject *__pyx_pf_9lambdaobj_get_gradients(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_gains, __Pyx_memviewslice __pyx_v_preds, long __pyx_v_n_preds, __Pyx_memviewslice __pyx_v_groups, __Pyx_memviewslice __pyx_v_query_boundaries, long __pyx_v_n_queries, __Pyx_memviewslice __pyx_v_discounts, __Pyx_memviewslice __pyx_v_inverse_max_dcgs, __Pyx_memviewslice __pyx_v_sigmoid_table, long __pyx_v_n_sigmoid_bins, double __pyx_v_min_sigmoid_arg, double __pyx_v_max_sigmoid_arg, double __pyx_v_sigmoid_idx_factor, __Pyx_memviewslice __pyx_v_grad, __Pyx_memviewslice __pyx_v_hess) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("get_gradients", 0);
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_1 < 0) {
    __pyx_t_1 += __pyx_v_gains.shape[0];
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_1 >= __pyx_v_gains.shape[0])) __pyx_t_2 = 0;
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_v_preds.shape[0];
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_3 >= __pyx_v_preds.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_4 < 0) {
    __pyx_t_4 += __pyx_v_groups.shape[0];
    if (unlikely(__pyx_t_4 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_4 >= __pyx_v_groups.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_5 < 0) {
    __pyx_t_5 += __pyx_v_query_boundaries.shape[0];
    if (unlikely(__pyx_t_5 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_5 >= __pyx_v_query_boundaries.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_6 < 0) {
    __pyx_t_6 += __pyx_v_discounts.shape[0];
    if (unlikely(__pyx_t_6 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_6 >= __pyx_v_discounts.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_7 < 0) {
    __pyx_t_7 += __pyx_v_inverse_max_dcgs.shape[0];
    if (unlikely(__pyx_t_7 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_7 >= __pyx_v_inverse_max_dcgs.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_8 < 0) {
    __pyx_t_8 += __pyx_v_sigmoid_table.shape[0];
    if (unlikely(__pyx_t_8 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_8 >= __pyx_v_sigmoid_table.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_9 < 0) {
    __pyx_t_9 += __pyx_v_grad.shape[0];
    if (unlikely(__pyx_t_9 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_9 >= __pyx_v_grad.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_10 < 0) {
    __pyx_t_10 += __pyx_v_hess.shape[0];
    if (unlikely(__pyx_t_10 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_10 >= __pyx_v_hess.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
 ...
 *                    n_preds,
 */
  __pyx_f_9lambdaobj__get_gradients((&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_gains.data) + __pyx_t_1)) )))), (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_preds.data) + __pyx_t_3)) )))), __pyx_v_n_preds, (&(*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_groups.data) + __pyx_t_4)) )))), (&(*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_query_boundaries.data) + __pyx_t_5)) )))), __pyx_v_n_queries, (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_discounts.data) + __pyx_t_6)) )))), (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_inverse_max_dcgs.data) + __pyx_t_7)) )))), (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_sigmoid_table.data) + __pyx_t_8)) )))), __pyx_v_n_sigmoid_bins, __pyx_v_min_sigmoid_arg, __pyx_v_max_sigmoid_arg, __pyx_v_sigmoid_idx_factor, (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_grad.data) + __pyx_t_9)) )))), (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_hess.data) + __pyx_t_10)) )))));
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_query_boundaries, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_discounts, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_inverse_max_dcgs, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_sigmoid_table, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_grad, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_hess, 1);
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "lambdaobj._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_lambdaobj(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_lambdaobj},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_inverse_max_dcgs, __pyx_k_inverse_max_dcgs, sizeof(__pyx_k_inverse_max_dcgs), 0, 0, 1, 1},
  {&__pyx_n_s_itemsize, __pyx_k_itemsize, sizeof(__pyx_k_itemsize), 0, 0, 1, 1},
  {&__pyx_kp_s_itemsize_0_for_cython_array, __pyx_k_itemsize_0_for_cython_array, sizeof(__pyx_k_itemsize_0_for_cython_array), 0, 0, 1, 0},
  {&__pyx_n_s_lambdaobj, __pyx_k_lambdaobj, sizeof(__pyx_k_lambdaobj), 0, 0, 1, 1},
  {&__pyx_n_s_main, __pyx_k_main, sizeof(__pyx_k_main), 0, 0, 1, 1},
  {&__pyx_n_s_max_sigmoid_arg, __pyx_k_max_sigmoid_arg, sizeof(__pyx_k_max_sigmoid_arg), 0, 0, 1, 1},
  {&__pyx_n_s_memview, __pyx_k_memview, sizeof(__pyx_k_memview), 0, 0, 1, 1},
  {&__pyx_n_s_min_sigmoid_arg, __pyx_k_min_sigmoid_arg, sizeof(__pyx_k_min_sigmoid_arg), 0, 0, 1, 1},
  {&__pyx_n_s_mode, __pyx_k_mode, sizeof(__pyx_k_mode), 0, 0, 1, 1},
  {&__pyx_kp_s_moltr_lambdaobj_pyx, __pyx_k_moltr_lambdaobj_pyx, sizeof(__pyx_k_moltr_lambdaobj_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_n_preds, __pyx_k_n_preds, sizeof(__pyx_k_n_preds), 0, 0, 1, 1},
  {&__pyx_n_s_n_queries, __pyx_k_n_queries, sizeof(__pyx_k_n_queries), 0, 0, 1, 1},
  {&__pyx_n_s_n_sigmoid_bins, __pyx_k_n_sigmoid_bins, sizeof(__pyx_k_n_sigmoid_bins), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_query_boundaries, __pyx_k_query_boundaries, sizeof(__pyx_k_query_boundaries), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_sigmoid_idx_factor, __pyx_k_sigmoid_idx_factor, sizeof(__pyx_k_sigmoid_idx_factor), 0, 0, 1, 1},
  {&__pyx_n_s_sigmoid_table, __pyx_k_sigmoid_table, sizeof(__pyx_k_sigmoid_table), 0, 0, 1, 1},
 ...
 *                   long n_preds,
 */
  __pyx_tuple__19 = PyTuple_Pack(15, __pyx_n_s_gains, __pyx_n_s_preds, __pyx_n_s_n_preds, __pyx_n_s_groups, __pyx_n_s_query_boundaries, __pyx_n_s_n_queries, __pyx_n_s_discounts, __pyx_n_s_inverse_max_dcgs, __pyx_n_s_sigmoid_table, __pyx_n_s_n_sigmoid_bins, __pyx_n_s_min_sigmoid_arg, __pyx_n_s_max_sigmoid_arg, __pyx_n_s_sigmoid_idx_factor, __pyx_n_s_grad, __pyx_n_s_hess); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 142, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(15, 0, 15, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_moltr_lambdaobj_pyx, __pyx_n_s_get_gradients, 142, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 142, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initlambdaobj(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initlambdaobj(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_lambdaobj(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_lambdaobj(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_lambdaobj(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'lambdaobj' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_lambdaobj(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("lambdaobj", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_lambdaobj) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "lambdaobj")) {
      if (unlikely(PyDict_SetItemString(modules, "lambdaobj", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *                   long n_preds,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9lambdaobj_1get_gradients, NULL, __pyx_n_s_lambdaobj); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 142, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_get_gradients, __pyx_t_1) < 0) __PYX_ERR(0, 142, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init lambdaobj", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init lambdaobj");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
